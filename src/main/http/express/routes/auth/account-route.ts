...
import { makeCreateAccountController, makeActiveAccountController, makeAuthenticationAccountController, makeListAccountController, makeRequestRecoverPasswordController, makeRecoverPasswordController, makeSetAccountTypeController } from '@/main/factories/controllers/auth'
